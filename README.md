...
> **Status: v0.14.3 (beta).** Usable and tested, but the API may still shift before 1.0.
...
Shipped through **v0.14.3**: the script-agnostic core and all four Aegean scripts; the full Greek
