...
> **Status: v0.44.1 (beta).** Usable and tested, but the API may still shift before 1.0.
...
Shipped through **v0.44.1**: the script-agnostic core and all four Aegean scripts; the full Greek
