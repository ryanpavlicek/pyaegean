...
> **Status: v0.13.0 (beta).** Usable and tested, but the API may still shift before 1.0.
...
Shipped through **v0.13.0**: the script-agnostic core and all four Aegean scripts; the full Greek
