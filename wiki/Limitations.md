...
| Rule-based lemmatizer | ~15.4% on the full NT (seed table + regular 2nd-decl/verb rules, ~+0.9pt over seed-only; the opt-in backends do far better) | Always-offline default |
