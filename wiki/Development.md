...
# 0.8.2 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.8.2-py3-none-any.whl: 2710 KB uncompressed, 142 files
...
# Checking dist/pyaegean-0.8.2-py3-none-any.whl: PASSED
```
