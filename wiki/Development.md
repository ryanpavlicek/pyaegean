...
# 0.26.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.26.0-py3-none-any.whl: 3552 KB uncompressed, 186 files
...
# Checking dist/pyaegean-0.26.0-py3-none-any.whl: PASSED
```
