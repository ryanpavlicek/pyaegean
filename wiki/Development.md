...
# 0.20.3 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.20.3-py3-none-any.whl: 3498 KB uncompressed, 180 files
...
# Checking dist/pyaegean-0.20.3-py3-none-any.whl: PASSED
```
