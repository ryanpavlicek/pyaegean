...
# 0.34.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.34.0-py3-none-any.whl: 3736 KB uncompressed, 197 files
...
# Checking dist/pyaegean-0.34.0-py3-none-any.whl: PASSED
```
