...
# 0.19.10 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.19.10-py3-none-any.whl: 3320 KB uncompressed, 175 files
...
# Checking dist/pyaegean-0.19.10-py3-none-any.whl: PASSED
```
