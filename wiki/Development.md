...
# 0.19.8 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.19.8-py3-none-any.whl: 3312 KB uncompressed, 175 files
...
# Checking dist/pyaegean-0.19.8-py3-none-any.whl: PASSED
```
