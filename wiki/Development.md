...
# 0.11.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.11.0-py3-none-any.whl: 2983 KB uncompressed, 160 files
...
# Checking dist/pyaegean-0.11.0-py3-none-any.whl: PASSED
```
