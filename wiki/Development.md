...
# 0.20.4 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.20.4-py3-none-any.whl: 3499 KB uncompressed, 180 files
...
# Checking dist/pyaegean-0.20.4-py3-none-any.whl: PASSED
```
