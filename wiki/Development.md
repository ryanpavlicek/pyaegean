...
# 0.14.2 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.14.2-py3-none-any.whl: 3061 KB uncompressed, 162 files
...
# Checking dist/pyaegean-0.14.2-py3-none-any.whl: PASSED
```
