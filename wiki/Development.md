...
# 0.19.15 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.19.15-py3-none-any.whl: 3343 KB uncompressed, 176 files
...
# Checking dist/pyaegean-0.19.15-py3-none-any.whl: PASSED
```
