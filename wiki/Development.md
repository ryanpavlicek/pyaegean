...
# 0.35.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.35.0-py3-none-any.whl: 3767 KB uncompressed, 199 files
...
# Checking dist/pyaegean-0.35.0-py3-none-any.whl: PASSED
```
