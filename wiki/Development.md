...
# 0.8.4 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.8.4-py3-none-any.whl: 2716 KB uncompressed, 143 files
...
# Checking dist/pyaegean-0.8.4-py3-none-any.whl: PASSED
```
