...
# 0.56.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.56.0-py3-none-any.whl: 4884 KB uncompressed, 226 files
...
# Checking dist/pyaegean-0.56.0-py3-none-any.whl: PASSED
```
