...
# 0.36.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.36.0-py3-none-any.whl: 3826 KB uncompressed, 201 files
...
# Checking dist/pyaegean-0.36.0-py3-none-any.whl: PASSED
```
