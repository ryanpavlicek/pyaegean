...
# 0.33.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.33.0-py3-none-any.whl: 3662 KB uncompressed, 194 files
...
# Checking dist/pyaegean-0.33.0-py3-none-any.whl: PASSED
```
