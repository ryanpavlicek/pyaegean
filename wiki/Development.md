...
# 0.8.10 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.8.10-py3-none-any.whl: 2765 KB uncompressed, 147 files
...
# Checking dist/pyaegean-0.8.10-py3-none-any.whl: PASSED
```
