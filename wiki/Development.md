...
# 0.13.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.13.0-py3-none-any.whl: 3029 KB uncompressed, 162 files
...
# Checking dist/pyaegean-0.13.0-py3-none-any.whl: PASSED
```
