...
# 0.53.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.53.0-py3-none-any.whl: 4849 KB uncompressed, 224 files
...
# Checking dist/pyaegean-0.53.0-py3-none-any.whl: PASSED
```
