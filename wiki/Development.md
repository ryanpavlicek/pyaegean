...
# 0.20.2 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.20.2-py3-none-any.whl: 3496 KB uncompressed, 180 files
...
# Checking dist/pyaegean-0.20.2-py3-none-any.whl: PASSED
```
