...
# 0.57.1 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.57.1-py3-none-any.whl: 4887 KB uncompressed, 226 files
...
# Checking dist/pyaegean-0.57.1-py3-none-any.whl: PASSED
```
