...
# 0.19.9 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.19.9-py3-none-any.whl: 3316 KB uncompressed, 175 files
...
# Checking dist/pyaegean-0.19.9-py3-none-any.whl: PASSED
```
