...
# 0.24.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.24.0-py3-none-any.whl: 3543 KB uncompressed, 184 files
...
# Checking dist/pyaegean-0.24.0-py3-none-any.whl: PASSED
```
