...
# 0.42.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.42.0-py3-none-any.whl: 4111 KB uncompressed, 211 files
...
# Checking dist/pyaegean-0.42.0-py3-none-any.whl: PASSED
```
