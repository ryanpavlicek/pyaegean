...
# 0.32.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.32.0-py3-none-any.whl: 3646 KB uncompressed, 193 files
...
# Checking dist/pyaegean-0.32.0-py3-none-any.whl: PASSED
```
