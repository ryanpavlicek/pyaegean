...
# 0.43.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.43.0-py3-none-any.whl: 4129 KB uncompressed, 212 files
...
# Checking dist/pyaegean-0.43.0-py3-none-any.whl: PASSED
```
