...
# 0.20.6 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.20.6-py3-none-any.whl: 3500 KB uncompressed, 180 files
...
# Checking dist/pyaegean-0.20.6-py3-none-any.whl: PASSED
```
