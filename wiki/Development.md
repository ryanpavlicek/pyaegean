...
# 0.37.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.37.0-py3-none-any.whl: 3902 KB uncompressed, 207 files
...
# Checking dist/pyaegean-0.37.0-py3-none-any.whl: PASSED
```
