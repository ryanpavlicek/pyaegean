...
# 0.23.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.23.0-py3-none-any.whl: 3536 KB uncompressed, 182 files
...
# Checking dist/pyaegean-0.23.0-py3-none-any.whl: PASSED
```
