...
# 0.57.2 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.57.2-py3-none-any.whl: 4895 KB uncompressed, 226 files
...
# Checking dist/pyaegean-0.57.2-py3-none-any.whl: PASSED
```
