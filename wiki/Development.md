...
# 0.19.14 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.19.14-py3-none-any.whl: 3341 KB uncompressed, 176 files
...
# Checking dist/pyaegean-0.19.14-py3-none-any.whl: PASSED
```
