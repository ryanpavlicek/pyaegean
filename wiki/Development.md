...
# 0.8.9 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.8.9-py3-none-any.whl: 2758 KB uncompressed, 147 files
...
# Checking dist/pyaegean-0.8.9-py3-none-any.whl: PASSED
```
