...
# 0.46.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.46.0-py3-none-any.whl: 4469 KB uncompressed, 216 files
...
# Checking dist/pyaegean-0.46.0-py3-none-any.whl: PASSED
```
