...
# 0.41.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.41.0-py3-none-any.whl: 4100 KB uncompressed, 210 files
...
# Checking dist/pyaegean-0.41.0-py3-none-any.whl: PASSED
```
