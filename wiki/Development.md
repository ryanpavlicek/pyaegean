...
# 0.19.11 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.19.11-py3-none-any.whl: 3327 KB uncompressed, 176 files
...
# Checking dist/pyaegean-0.19.11-py3-none-any.whl: PASSED
```
