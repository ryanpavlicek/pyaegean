...
# 0.52.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.52.0-py3-none-any.whl: 4846 KB uncompressed, 224 files
...
# Checking dist/pyaegean-0.52.0-py3-none-any.whl: PASSED
```
