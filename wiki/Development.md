...
# 0.19.12 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.19.12-py3-none-any.whl: 3333 KB uncompressed, 176 files
...
# Checking dist/pyaegean-0.19.12-py3-none-any.whl: PASSED
```
