...
# 0.22.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.22.0-py3-none-any.whl: 3532 KB uncompressed, 181 files
...
# Checking dist/pyaegean-0.22.0-py3-none-any.whl: PASSED
```
