...
# 0.25.0 ['cypriot', 'cyprominoan', 'greek', 'lineara', 'linearb']
```
...
# wheel dist/pyaegean-0.25.0-py3-none-any.whl: 3548 KB uncompressed, 185 files
...
# Checking dist/pyaegean-0.25.0-py3-none-any.whl: PASSED
```
