...
> **Status: v0.27.1 (beta).** The API is close to stable but may still shift before 1.0.
...
**Current release: v0.27.1.** pyaegean covers all four Aegean scripts, fourteen loadable corpora
